...
qa_label = text(0.5,0.5,0.5,sprintf(['$$q_a = \\left( {\\matrix{ %0.4f \\cr ' ...
  '%0.4f \\cr %0.4f \\cr %0.4f } } \\right) $$'],true_state1.q.vector(1), ...
  ...
  if (frame < switch_frame)
    ...
    if (last_true_plot ~= 2)
      set(qa_label,'String',sprintf(['$$q_a = \\left( {\\matrix{ %0.4f \\cr %0.4f ' ...
        '\\cr %0.4f \\cr %0.4f } } \\right) $$'],true_state2.q.vector(1), ...
        true_state2.q.vector(2),true_state2.q.vector(3),true_state2.q.scalar));
      last_true_plot = 2;
