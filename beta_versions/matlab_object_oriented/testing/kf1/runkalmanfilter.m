...
% Run the simulation for 100 samples
tspan = [0 100];
...
xlabel('Time (s)');
ylabel('Position (m)');
%legend('True position','Measurements','Kalman estimated displacement','Location','NorthEast');
...
xlabel('Time (s)');
ylabel('Velocity (m/s)');
%legend('Estimated velocity by raw consecutive samples','Estimated velocity by running average','True velocity','Estimated velocity by Kalman filter','Location','NorthEast');
