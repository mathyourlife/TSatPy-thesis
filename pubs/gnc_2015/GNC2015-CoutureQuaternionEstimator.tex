...
\documentclass[]{aiaa-tc}% insert '[draft]' option to show overfull boxes
 ...
 \title{Quaternion Attitude State Estimation without Normalization}
...
\begin{abstract}
Quaternion-based state attitude estimation techniques such as PID and EKF state
estimators

require the normalization of the quaternion as a post processing step.
