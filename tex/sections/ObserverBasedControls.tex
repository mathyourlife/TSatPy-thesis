...
% Not actually a subsection, but is worth a note in the table of contents for easy reference
\addcontentsline{toc}{subsection}{\hspace*{2cm}Quaternion Decomposition}
...
\subsubsection{P Rate and Nutation Control Starting at Rest}
\label{subsubsec:PRateNutationControlStartingatRest}
...
\subsubsection{PID Rate and Nutation Control}
\label{subsubsec:PIDRateandNutationControl}

\TODO{this}

\subsubsection{SMC Rate and Nutation Control}
\label{subsubsec:SMC}
