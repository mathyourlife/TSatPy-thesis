...
\TODO{Trying to get good gain values so the graphs don't look hideous.. this'll be a tada see it's possible, but could be pretty with better modeling gain selection, etc}
