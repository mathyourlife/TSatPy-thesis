...
% [C]{UDP}{User Data Gram Protocol.  Session-less and unverified data transfer.}
% [C]{TCP}{Transmission Control Protocol.  Session based data transfer where all transfers are confirmed on receipt.}


\TODO{Are nomenclature listings generally limited to defining mathematical representations or can they also include commonly used acronyms?}
